...
<div className="main-slider-one__content">
        ...
        <h1 className='heading_middle content_why_invest'>WHERE TRANQUILLITY MEETS TIMELESS LUXURY</h1>
        </div>
      </div>
      <div className=''>
        <p className="down_styling para_styling mobile_para">
 The Palace Villas Ostra at The Oasis is the final collection of 4, 5, and 6-bedroom branded villas by Emaar, blending contemporary architecture with serene waterways and lush landscapes. Set in a prime waterfront location, it offers a peaceful lifestyle with effortless access to Dubai’s major destinations.
</p>
 <p className="down_styling para_styling mobile_para">
 Each villa features elegant modern façades, light-filled interiors, premium finishes, and calming natural tones. With swimmable lagoons, parks, fitness facilities, sports courts, and a dedicated spa, The Oasis delivers a refined, wellness-focused living experience where tranquillity and luxury come together.
</p>
      ...
      <div className="why_invest_wrapper why_invest_wrapper_mobile shadow_i">
                     <div className="model_image_container">
                        <Image
                        src="/assets/img/oasis_model_picture.png"
                        alt="Model Image"
                        height={1000}
                        width={1000}
       ...
       <div className="row feature_row">
                ...
                <p className="investment_text">
                  <span className="about_para_span">Q2 2029.</span>
                </p> 
                                            </div>
                                        </div>
                                    </div>
                ...
                <p className="investment_text">
                  <span className="about_para_span">ROI.</span>
                      ...
                      />
                                                ...
                                                <h2 className="investment_content">
                <a href="javascript:void(0);">Waterfront Living</a></h2>
                <p className="investment_text">
                  <span className="about_para_span">Where Luxury & Nature Unite.</span>
                </p> 
                                            </div>
                                        </div>
                                    </div>
